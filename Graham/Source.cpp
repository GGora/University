...
/*
This application takes the set of points
and makes the set of points are included 
in the convex hull.
The set of points is taken from file.
Form of the file:
	x1 y1
	x2 y2
	...
	xn yn
As result, application creates the file
containing convex hull.
If the paths are incorrect, app will 
form rhe exception.
*/
